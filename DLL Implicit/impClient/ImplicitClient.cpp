/*
	...
	2. Revise about the topics such as : 
		...
		b. and also the topic related with DLL's BASIC CONCEPT...
...
// As we are neither calling LoadLibrary() nor calling GetProcAddress() for the Implicit Linking...
// Included the header file which contains prototype for the imported functions from the server-side...
				   ...
				   )
{
	...
	hwnd=CreateWindow
		 (
		        ...
		        TEXT("User Of Implicit Sever's Dll"), // Pointer to a null-terminated string that specifies the window name.
...
LRESULT CALLBACK WndProc(HWND hwnd,UINT iMsg,WPARAM wParam,LPARAM lParam)
{
	...
	TCHAR str[255];	// an array of size (255 * 2) is created...
	...
	switch(iMsg)
	{
		...
		*/	
						...
						// n3 contains addition of (n1 and n2)
						...
						// n3 contains difference of (n1 and n2)
		...
		case WM_DESTROY :
		/*
		This message is sent when a window is being destroyed.This message is sent first to the window being
